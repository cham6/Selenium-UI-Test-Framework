...
public class BranchPage extends BasePage {
	...
	/**
	 * Perform edit of a given branch code and name and verify if it is successful
	 * @param branchName
	 * @param branchCode
	 * @param newBranchName
	 * @param newBranchCode
	...
	public boolean isEditBranchSuccessful(String branchName, String branchCode, 
		...
		try {
			...
			System.out.println("Exception while editing the branch Name and Code");
	...
	/**
	 * Perform Delete of a given branch code and name and verify if it is successful
	 * @param branchName
	 * @param branchCode
