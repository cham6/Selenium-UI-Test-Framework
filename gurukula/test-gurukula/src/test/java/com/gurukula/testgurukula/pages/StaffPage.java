...
public class StaffPage extends BasePage {
	...
	/**
	 * Check if the staff is available in the Staffs WebTable.
	 * @param staffName
	 * @param staffRelatedBranchName
	 * @return true if the given staff is available. False, otherwise.
	 */
	...
	/**
	 * Check if View of given staff is successful
	 * @param staffName
	 * @param staffRelatedBranchName
	 ...
	 * @param staffRelatedBranchName
	 * @param newStaffName
	 * @param newStaffRelatedBranchCode
	 * @return  true if successful. false, otherwise.
	 */
